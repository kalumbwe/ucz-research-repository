-- ============================================================
-- UCZ University Research Repository - AIVEN VERSION
-- Modified for Aiven MySQL deployment
-- ============================================================

-- NOTE: Do NOT use CREATE DATABASE on Aiven
-- Aiven creates 'defaultdb' automatically - use that
...
CREATE TABLE IF NOT EXISTS research_reports (
    ...
    keywords VARCHAR(400) NULL COMMENT 'comma separated keywords',
    language VARCHAR(50) DEFAULT 'English',
    pages INT NULL,
    isbn_issn VARCHAR(50) NULL,
    file_name VARCHAR(255) NOT NULL COMMENT 'stored file name on disk',
...
-- Default admin: username = admin | password = ChangeMe@123
